...
- (void)showPhotoDisplayController
{
    ...
    DZNPhotoDisplayViewController *controller = [[DZNPhotoDisplayViewController alloc] initWithColumnCount:self.columnCount];
    controller.maxImageSize = self.maxImageSize;
